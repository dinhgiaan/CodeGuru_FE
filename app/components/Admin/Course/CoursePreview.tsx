...
const CoursePreview: FC<Props> = ({
  ...
  const discountPercent =
    ((courseData?.suggestedPrice - courseData?.price) /
      courseData?.suggestedPrice) *
    100;
    ...
    <div className="w-[90%] m-auto py-5 mb-5">
      <div className="w-full relative">
        ...
        <div className="flex items-center dark:text-white text-black ml-14">
          <h1 className="pt-5 text-[25px]">
            {courseData?.price === 0
              ? "Miễn phí"
              : formatVNDPrice(courseData?.price)}
          </h1>
      ...
      <div className="w-full ml-14">
        ...
        <div className="w-full flex items-center justify-between">
          <div
            className="w-full 800px:w-[180px] flex items-center justify-center h-[40px] bg-[#37a39a] text-center text-[#fff] round mt-8 cursor-pointer"
            onClick={() => prevButton()}
          >
            Quay lại
          </div>
