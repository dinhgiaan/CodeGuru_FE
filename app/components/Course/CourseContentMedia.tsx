    ...
    <div className="w-[95%] 800px:w-[86%] py-4 m-auto">
      ...
      <div className="w-full flex items-center justify-between my-3">
        ...
        <div
          className={`${
            style.button
          } !w-[unset] w-[80px] !min-h-[40px] !py-[unset] ${
      ...
      {activeBar === 2 && (
        <>
          ...
          <div className="w-full flex justify-end">
            <div
              className={`${style.button} !w-[120px] !h-[40px] text-[18px] mt-5`}
            >
              Đăng
            </div>
          </div>
          ...
          <>
            {!isReviewExists && (
              <>
                ...
                <div className="w-full flex justify-end">
                  <div
                    className={`${style.button} !w-[120px] !h-[40px] text-[18px] mt-5 800px:mr-0 mr-2`}
                  >
                    Đăng
                  </div>
                </div>
